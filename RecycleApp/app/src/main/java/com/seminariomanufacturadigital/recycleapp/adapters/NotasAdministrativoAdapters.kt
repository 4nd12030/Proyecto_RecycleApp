...
class NotasAdministrativoAdapters(val context: FragmentActivity, val notas:ArrayList<Nota>):  RecyclerView.Adapter<NotasAdministrativoAdapters.NotasViewHolder>() {
    val TAG = "NotasAdministrativoAdapters"
    ...
    override fun onBindViewHolder(holder: NotasViewHolder, position: Int) {
        ...
        if(nota.estado == "ENVIADA" || nota.estado == "PENDIENTE"){
    ...
    private fun goToEditNota(nota: Nota) {
        Log.d(TAG, "${ nota }")
        val i = Intent(context, AdministrativoUpdateNotaActivity::class.java)
